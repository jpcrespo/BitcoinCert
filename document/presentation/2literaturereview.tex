...
\vspace*{0.2cm}
\hspace*{0.25cm}
{\centering \includegraphics[scale=0.5]{figures/tx.pdf}\\}
\vspace*{0.2cm}
...
\begin{itemize}
    ...
    \item Merkle-based aggregation is not enforced at the protocol level and must be implemented off-chain.
\end{itemize}
\end{frame}
