...
\begin{frame}{Methodology}
    ...
    \end{itemize}
    \vspace*{0.3cm}
    Verification is performed \textbf{off-chain} using a \textbf{control file} provided  together with the document.\\
    \vspace*{0.1cm}
...
\begin{frame}{Phase I}
    ...
    \begin{block}{Privacy Preserved}
        ...
        Only the script leaf related to the verified document is revealed.
